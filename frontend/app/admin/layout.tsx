...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
      <div className="flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-900 transition-colors">
        ...
        {/* Sidebar */}
        <aside
          className={`fixed inset-y-0 left-0 z-50 w-64 md:static md:z-auto h-screen shrink-0 overflow-y-auto bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col p-4 transition-transform duration-200 md:translate-x-0 ${
